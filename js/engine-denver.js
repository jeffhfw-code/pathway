...
function runEngine(f){
  ...
  const lot=f.lotSize||0,rcN=f.rcWithin1mi||0,rc34=f.rcType34within1mi||0,d34=f.distType34!=null?f.distType34:999999,cor=f.correctional==="yes",rel=f.religious==="yes",exRC=f.existingRC,mnt=f.maintained;
  const R=[],gS=[],gC=[];
  // Licensing hardcoded — BH/SUD operators always have state licensing (FORM_DEFAULTS)
